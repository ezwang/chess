...
public class Queen extends Piece {
    private static final Location[] DIRECTIONS = new Location[] { new Location(1, 1), new Location(-1, 1), new Location(-1, -1), new Location(1, -1), new Location(1, 0), new Location(0, 1), new Location(-1, 0), new Location(0, -1) };
